...
const socials = [
  {
    label: "Instagram",
    href: "https://instagram.com/AdhamFathallahProperty",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@AdhamFathallahProperty",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/AdhamFathallahProperty",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
